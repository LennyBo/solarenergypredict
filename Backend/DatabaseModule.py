...
class DatabaseModule:
    ...
    def create_table(self):
        ...
        db.execute('''CREATE TABLE IF NOT EXISTS DailyEnergy (
                ...
                solar_night_morning_predicted INTERGER,
                solar_morning_noon_predicted INTERGER,
                solar_noon_evening_predicted INTERGER,
                solar_evening_night_predicted INTERGER,
